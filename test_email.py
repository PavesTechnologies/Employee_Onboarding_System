...
def main():
    print("\n--- Sending Reassigned Joining Letter Email ---")

    send_joining_email(
        to_email=TEST_RECIPIENT,
        name="Preethika",
        joining_date_str="20 September 2026",
        location="Hyderabad",
        reporting_time="10:00 AM",
        department="Software Development",
        reporting_manager="HR Team",
        custom_message="Your joining date has been rescheduled. Please refer to the updated joining details below.",
    )


if __name__ == "__main__":from Backend.Business_Layer.utils.email_utils import (
    send_email,
