...
class Departments(Base):
    ...
    designations: Mapped[list["Designations"]] = relationship(
        "Designations", back_populates="departments"
    )
    employee_details: Mapped[list["EmployeeDetails"]] = relationship(
        "EmployeeDetails", back_populates="departments"
    )
    employee_exit: Mapped[list["EmployeeExit"]] = relationship(
        "EmployeeExit", back_populates="department"
    )
...
class Designations(Base):
    ...
    departments: Mapped["Departments"] = relationship(
        "Departments", back_populates="designations"
    )
    employee_details: Mapped[list["EmployeeDetails"]] = relationship(
        "EmployeeDetails", back_populates="designations"
    )
    employee_exit: Mapped[list["EmployeeExit"]] = relationship(
        "EmployeeExit", back_populates="designation"
    )
...
class EducationDocumentType(Base):
    ...
    country_education_document_mapping: Mapped[
        ...
        "CountryEducationDocumentMapping", back_populates="education_document_type"
    )
...
class EducationLevel(Base):
    ...
    country_education_document_mapping: Mapped[
        ...
        "CountryEducationDocumentMapping", back_populates="education_level"
    )

    degree_master: Mapped[list["DegreeMaster"]] = relationship(
        "DegreeMaster", back_populates="education_level", lazy="selectin"
    )


class IdentityType(Base):
    __tablename__ = "identity_type"
    __table_args__ = (Index("identity_type_uuid", "identity_type_uuid", unique=True),)
    ...
    country_identity_mapping: Mapped[list["CountryIdentityMapping"]] = relationship(
        "CountryIdentityMapping", back_populates="identity_type"
    )
...
class OfferLetterDetails(Base):
    ...
    hire_type: Mapped[Optional[str]] = mapped_column(
        Enum("Direct", "Offer"), nullable=True
    )
    ...
    addresses: Mapped[list["Addresses"]] = relationship(
        "Addresses", back_populates="offer_letter_details"
    )
    contacts: Mapped[list["Contacts"]] = relationship(
        "Contacts", back_populates="offer_letter_details"
    )
    employee_deliverables: Mapped[list["EmployeeDeliverables"]] = relationship(
        "EmployeeDeliverables", back_populates="offer_letter_details"
    )
    employee_details: Mapped[list["EmployeeDetails"]] = relationship(
        "EmployeeDetails", back_populates="offer_letter_details"
    )
    employee_experience: Mapped[list["EmployeeExperience"]] = relationship(
        "EmployeeExperience", back_populates="offer_letter_details"
    )
    employee_receivables: Mapped[list["EmployeeReceivables"]] = relationship(
        "EmployeeReceivables", back_populates="offer_letter_details"
    )
    offer_approval_request: Mapped[list["OfferApprovalRequest"]] = relationship(
        "OfferApprovalRequest", back_populates="offer_letter_details"
    )
    offer_compensation: Mapped[list["OfferCompensation"]] = relationship(
        "OfferCompensation", back_populates="offer_letter_details"
    )
    onboarding_links: Mapped[list["OnboardingLinks"]] = relationship(
        "OnboardingLinks", back_populates="offer_letter_details"
    )
    personal_details: Mapped[list["PersonalDetails"]] = relationship(
        "PersonalDetails", back_populates="offer_letter_details"
    )
    employee_education_document: Mapped[list["EmployeeEducationDocument"]] = (
        relationship("EmployeeEducationDocument", back_populates="offer_letter_details")
    )
    employee_identity_document: Mapped[list["EmployeeIdentityDocument"]] = relationship(
        "EmployeeIdentityDocument", back_populates="offer_letter_details"
    )
    employee_social_links: Mapped[list["EmployeeSocialLink"]] = relationship(
        "EmployeeSocialLink", back_populates="offer_letter_details"
    )
    employee_pay_slips: Mapped[list["EmployeePaySlips"]] = relationship(
        "EmployeePaySlips", back_populates="offer_letter_details"
    )
    employee_relieving_letter: Mapped[list["EmployeeRelievingLetter"]] = relationship(
        "EmployeeRelievingLetter", back_populates="offer_letter_details"
    )

    employee_bank_details: Mapped[list["EmployeeBankDetails"]] = relationship(
        "EmployeeBankDetails", lazy="selectin"
    )
    employee_pf_details: Mapped[list["EmployeePfDetails"]] = relationship(
        "EmployeePfDetails", lazy="selectin"
    )
...
class ReceivableItems(Base):
    ...
    __table_args__ = (Index("receivable_uuid", "receivable_uuid", unique=True),)
    ...
    employee_receivables: Mapped[list["EmployeeReceivables"]] = relationship(
        "EmployeeReceivables", back_populates="receivable_items"
    )
...
class Addresses(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["country_uuid"], ["countries.country_uuid"], name="addresses_ibfk_2"
        ),
        ForeignKeyConstraint(
            ["user_uuid"], ["offer_letter_details.user_uuid"], name="addresses_ibfk_1"
        ),
    ...
    countries: Mapped["Countries"] = relationship(
        "Countries", back_populates="addresses"
    )
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="addresses"
    )
...
class Contacts(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["country_uuid"], ["countries.country_uuid"], name="contacts_ibfk_2"
        ),
        ForeignKeyConstraint(
            ["user_uuid"], ["offer_letter_details.user_uuid"], name="contacts_ibfk_1"
        ),
    ...
    countries: Mapped["Countries"] = relationship(
        "Countries", back_populates="contacts"
    )
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="contacts"
    )
...
class CountryEducationDocumentMapping(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            name="country_education_document_mapping_ibfk_1",
        ),
        ForeignKeyConstraint(
            ["education_document_uuid"],
            ["education_document_type.education_document_uuid"],
            name="country_education_document_mapping_ibfk_3",
        ),
        ForeignKeyConstraint(
            ["education_uuid"],
            ["education_level.education_uuid"],
            name="country_education_document_mapping_ibfk_2",
        ),
        Index("country_uuid", "country_uuid"),
    ...
    education_uuid: Mapped[str] = mapped_column(CHAR(36), nullable=False)
    education_document_uuid: Mapped[str] = mapped_column(CHAR(36), nullable=False)
    is_mandatory: Mapped[Optional[int]] = mapped_column(
        TINYINT(1), server_default=text("'1'")
    )
    created_at: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, server_default=text("CURRENT_TIMESTAMP")
    ...
    countries: Mapped["Countries"] = relationship(
        "Countries", back_populates="country_education_document_mapping"
    )
    education_document_type: Mapped["EducationDocumentType"] = relationship(
        "EducationDocumentType", back_populates="country_education_document_mapping"
    )
    education_level: Mapped["EducationLevel"] = relationship(
        "EducationLevel", back_populates="country_education_document_mapping"
    )
    employee_education_document: Mapped[list["EmployeeEducationDocument"]] = (
        relationship(
            "EmployeeEducationDocument",
            back_populates="country_education_document_mapping",
        )
    )
...
class CountryIdentityMapping(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["country_uuid"],
            ["countries.country_uuid"],
            name="country_identity_mapping_ibfk_1",
        ),
        ForeignKeyConstraint(
            ["identity_type_uuid"],
            ["identity_type.identity_type_uuid"],
            name="country_identity_mapping_ibfk_2",
        ),
        Index("country_uuid", "country_uuid"),
    ...
    countries: Mapped["Countries"] = relationship(
        "Countries", back_populates="country_identity_mapping"
    )
    identity_type: Mapped["IdentityType"] = relationship(
        "IdentityType", back_populates="country_identity_mapping"
    )
    employee_identity_document: Mapped[list["EmployeeIdentityDocument"]] = relationship(
        "EmployeeIdentityDocument", back_populates="country_identity_mapping"
    )
...
class EmployeeDeliverables(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["deliverable_uuid"],
            ["deliverable_items.deliverable_uuid"],
            name="employee_deliverables_ibfk_2",
        ),
        ForeignKeyConstraint(
            ["user_uuid"],
            ["offer_letter_details.user_uuid"],
            name="employee_deliverables_ibfk_1",
        ),
    ...
    deliverable_uuid: Mapped[str] = mapped_column(CHAR(36), nullable=False)
    status: Mapped[Optional[str]] = mapped_column(
        Enum("Pending", "Delivered", "Returned"), server_default=text("'Pending'")
    )
    ...
    deliverable_items: Mapped["DeliverableItems"] = relationship(
        "DeliverableItems", back_populates="employee_deliverables"
    )
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="employee_deliverables"
    )
...
class EmployeeDetails(Base):
    ...
    work_mode: Mapped[str] = mapped_column(
        Enum("Office", "Remote", "Hybrid"), nullable=False
    )
    ...
    export_status: Mapped[Optional[str]] = mapped_column(
        Enum("NOT_EXPORTED", "SUCCESS", "FAILED", "ALREADY_EXISTS"),
        server_default=text("'NOT_EXPORTED'"),
    )
    ...
    designations: Mapped[Optional["Designations"]] = relationship(
        "Designations", back_populates="employee_details"
    )
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="employee_details"
    )
    employee_exit: Mapped[list["EmployeeExit"]] = relationship(
        "EmployeeExit", back_populates="employee_details"
    )
    exit_clearance: Mapped[list["ExitClearance"]] = relationship(
        "ExitClearance", back_populates="employee_details"
    )
    exit_documents: Mapped[list["ExitDocuments"]] = relationship(
        "ExitDocuments", back_populates="employee_details"
    )
    exit_final_settlement: Mapped[list["ExitFinalSettlement"]] = relationship(
        "ExitFinalSettlement", back_populates="employee_details"
    )
    exit_interview: Mapped[list["ExitInterview"]] = relationship(
        "ExitInterview", back_populates="employee_details"
    )
    employee_about: Mapped[Optional["EmployeeAbout"]] = relationship(
        "EmployeeAbout", back_populates="employee_details", uselist=False
    )
...
class EmployeeExperience(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["employee_uuid"],
            ["offer_letter_details.user_uuid"],
            name="employee_experience_ibfk_1",
        ),
    ...
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="employee_experience"
    )
    employee_pay_slips: Mapped[list["EmployeePaySlips"]] = relationship(
        "EmployeePaySlips", back_populates="employee_experience"
    )
    employee_relieving_letter: Mapped[list["EmployeeRelievingLetter"]] = relationship(
        "EmployeeRelievingLetter", back_populates="employee_experience"
    )
...
class EmployeeReceivables(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["receivable_uuid"],
            ["receivable_items.receivable_uuid"],
            name="employee_receivables_ibfk_2",
        ),
        ForeignKeyConstraint(
            ["user_uuid"],
            ["offer_letter_details.user_uuid"],
            name="employee_receivables_ibfk_1",
        ),
    ...
    receivable_uuid: Mapped[str] = mapped_column(CHAR(36), nullable=False)
    status: Mapped[Optional[str]] = mapped_column(
        Enum("Pending", "Received", "Not Received"), server_default=text("'Pending'")
    )
    ...
    receivable_items: Mapped["ReceivableItems"] = relationship(
        "ReceivableItems", back_populates="employee_receivables"
    )
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="employee_receivables"
    )
...
class OfferApprovalRequest(Base):
    ...
    request_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        TIMESTAMP, server_default=text("CURRENT_TIMESTAMP")
    )

    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="offer_approval_request"
    )
    offer_approval_action: Mapped[list["OfferApprovalAction"]] = relationship(
        "OfferApprovalAction", back_populates="request"
    )
...
class OfferCompensation(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["offer_letter_details.user_uuid"],
            ondelete="CASCADE",
            name="fk_offer_compensation_offer",
        ),
    ...
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="offer_compensation"
    )
...
class OnboardingLinks(Base):
    ...
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="onboarding_links"
    )
...
class PersonalDetails(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["countries.country_uuid"],
            name="personal_details_ibfk_2",
        ),
        ForeignKeyConstraint(
            ["residence_country_uuid"],
            ["countries.country_uuid"],
            name="personal_details_ibfk_3",
        ),
        ForeignKeyConstraint(
            ["user_uuid"],
            ["offer_letter_details.user_uuid"],
            name="personal_details_ibfk_1",
        ),
        ForeignKeyConstraint(
            ["emergency_contact_relation_uuid"],
            ["relation_master.relation_uuid"],
            name="personal_details_ibfk_4",
        ),
...
class RelationMaster(Base):
    ...
    __table_args__ = (Index("relation_uuid", "relation_uuid", unique=True),)
    ...
    personal_details: Mapped[list["PersonalDetails"]] = relationship(
        "PersonalDetails", back_populates="relation_master"
    )
...
class EmployeeEducationDocument(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["mapping_uuid"],
            ["country_education_document_mapping.mapping_uuid"],
            name="employee_education_document_ibfk_1",
        ),
        ForeignKeyConstraint(
            ["user_uuid"],
            ["offer_letter_details.user_uuid"],
            name="employee_education_document_ibfk_2",
        ),
        ForeignKeyConstraint(
            ["degree_uuid"],
            ["degree_master.degree_uuid"],
            name="employee_education_document_ibfk_3",
        ),
    ...
    employee_education_document_id: Mapped[int] = mapped_column(
    ...
    country_education_document_mapping: Mapped["CountryEducationDocumentMapping"] = (
        relationship(
...
class DegreeMaster(Base):
    ...
    # relationships
    education_level: Mapped["EducationLevel"] = relationship(
        "EducationLevel", back_populates="degree_master", lazy="selectin"
    )

    employee_education_document: Mapped[list["EmployeeEducationDocument"]] = (
        relationship(
            "EmployeeEducationDocument", back_populates="degree_master", lazy="selectin"
        )
    )
...
class EmployeeIdentityDocument(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["mapping_uuid"],
            ["country_identity_mapping.mapping_uuid"],
            name="employee_identity_document_ibfk_1",
        ),
        ForeignKeyConstraint(
            ["user_uuid"],
            ["offer_letter_details.user_uuid"],
            name="employee_identity_document_ibfk_2",
        ),
        Index("document_uuid", "document_uuid", unique=True),
    ...
    employee_identity_document_id: Mapped[int] = mapped_column(
        Integer, primary_key=True
    )
    document_uuid: Mapped[str] = mapped_column(CHAR(36), nullable=False)
    mapping_uuid: Mapped[str] = mapped_column(CHAR(36), nullable=False)
    ...
    country_identity_mapping: Mapped["CountryIdentityMapping"] = relationship(
        "CountryIdentityMapping", back_populates="employee_identity_document"
    )
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="employee_identity_document"
    )
...
class EmployeeSocialLink(Base):
    ...
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="employee_social_links"
    )
...
class EmployeeAbout(Base):
    ...
    employee_details: Mapped["EmployeeDetails"] = relationship(
        "EmployeeDetails", back_populates="employee_about"
    )
...
class EmployeePaySlips(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["employee_uuid"],
            ["offer_letter_details.user_uuid"],
            name="employee_pay_slips_ibfk_1",
        ),
        ForeignKeyConstraint(
            ["experience_uuid"],
            ["employee_experience.experience_uuid"],
            name="employee_pay_slips_ibfk_2",
        ),
        Index("employee_uuid", "employee_uuid"),
    ...
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="employee_pay_slips"
    )
    employee_experience: Mapped["EmployeeExperience"] = relationship(
        "EmployeeExperience", back_populates="employee_pay_slips"
    )
...
class EmployeeRelievingLetter(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["employee_uuid"],
            ["offer_letter_details.user_uuid"],
            name="employee_relieving_letter_ibfk_1",
        ),
        ForeignKeyConstraint(
            ["experience_uuid"],
            ["employee_experience.experience_uuid"],
            name="employee_relieving_letter_ibfk_2",
        ),
        Index("employee_uuid", "employee_uuid"),
        Index("experience_uuid", "experience_uuid"),
    ...
    offer_letter_details: Mapped["OfferLetterDetails"] = relationship(
        "OfferLetterDetails", back_populates="employee_relieving_letter"
    )
    employee_experience: Mapped["EmployeeExperience"] = relationship(
        "EmployeeExperience", back_populates="employee_relieving_letter"
    )
...
class OfferApprovalAction(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["request_id"],
            ["offer_approval_request.id"],
            ondelete="CASCADE",
            name="fk_offer_action_request",
        ),
    ...
    action_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        TIMESTAMP, server_default=text("CURRENT_TIMESTAMP")
    )

    request: Mapped["OfferApprovalRequest"] = relationship(
        "OfferApprovalRequest", back_populates="offer_approval_action"
    )
...
class EmployeeExit(Base):
    ...
    department: Mapped["Departments"] = relationship(
        "Departments", back_populates="employee_exit", lazy="selectin"
    )

    designation: Mapped["Designations"] = relationship(
        "Designations", back_populates="employee_exit", lazy="selectin"
    )

    employee_details: Mapped["EmployeeDetails"] = relationship(
        "EmployeeDetails", back_populates="employee_exit", lazy="selectin"
    )
...
class ExitApprovals(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["exit_uuid"], ["employee_exit.exit_uuid"], name="exit_approvals_ibfk_1"
        ),
    ...
    approval_type: Mapped[str] = mapped_column(Enum("Manager", "HR"))

    status: Mapped[str] = mapped_column(
        Enum("Pending", "Approved", "Rejected"), server_default=text("'Pending'")
    )
    ...
    employee_exit: Mapped["EmployeeExit"] = relationship(
        "EmployeeExit", back_populates="approvals", lazy="selectin"
    )
...
class ExitFinalSettlement(Base):
    ...
    status: Mapped[str] = mapped_column(
        Enum("Pending", "Approved", "Paid"), server_default=text("'Pending'")
    )
    ...
    employee_details = relationship(
        "EmployeeDetails", back_populates="exit_final_settlement"
    )
...
class EmployeeTasks(Base):
    ...
    task_uuid: Mapped[str] = mapped_column(CHAR(36), unique=True, nullable=False)
    ...
    priority: Mapped[str] = mapped_column(
        Enum("High", "Medium", "Low", name="task_priority_enum"),
        default="Medium",
        nullable=False,
    )
    ...
    # Status
    status: Mapped[str] = mapped_column(
        Enum("To Do", "In Progress", "Completed", "Cancelled", name="task_status_enum"),
        default="To Do",
        nullable=False,
    )
    ...
    # Escalation
    escalation_owner: Mapped[Optional[str]] = mapped_column(String(150))
    ...
    completed_by: Mapped[Optional[str]] = mapped_column(String(150))

    completed_at: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime)

    # Relationship with Offer Letter Details
    offer_letter = relationship("OfferLetterDetails", backref="employee_tasks")
...
class ExitClearanceItems(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(["clearance_uuid"], ["exit_clearance.clearance_uuid"]),
    ...
    status: Mapped[str] = mapped_column(
        Enum("Pending", "Completed"), server_default=text("'Pending'")
    )
    ...
    exit_clearance = relationship("ExitClearance", back_populates="items")
