...
async def get_dashboard_data_from_db(db, start_date, end_date):
    ...
    stmt = (
        ...
        .outerjoin(
            EmployeeDetails, OfferLetterDetails.user_uuid == EmployeeDetails.user_uuid
        )
        .outerjoin(
        ...
        .outerjoin(
            ...
            employee_designation.department_uuid
            == employee_designation_department.department_uuid,
        )
        .outerjoin(
            offer_designation,
