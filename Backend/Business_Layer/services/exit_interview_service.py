...
class ExitInterviewService:
    ...
    async def create_exit_interview(self, db, data):
        existing = await self.dao.get_exit_interview_by_exit_uuid(db, data.exit_uuid)
    ...
    async def update_exit_interview(self, db, interview_uuid, data):
        interview = await self.dao.update_exit_interview(db, interview_uuid, data)
    ...
    async def delete_exit_interview(self, db, interview_uuid):
        deleted = await self.dao.delete_exit_interview(db, interview_uuid)
