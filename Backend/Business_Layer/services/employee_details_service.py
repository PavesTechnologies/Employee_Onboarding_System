...
class EmployeeDetailsService:
    ...
    async def get_profile_photo(
        ...
        if not personal.profile_photo_path:
            raise HTTPException(
                status_code=404,
        ...
        return {
            "profile_photo_path": personal.profile_photo_path,
            "profile_photo_url": profile_photo_url
        }
    ...
    async def update_profile_photo(
        ...
        if not personal.profile_photo_path:
            raise HTTPException(
                status_code=404,
                detail="No profile photo found to update"
            )
    ...
    async def delete_profile_photo(
        ...
        await self.dao.delete_profile_photo_path(
            user_uuid
        )
