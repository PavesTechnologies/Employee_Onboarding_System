...
class AuditUtils:
    def __init__(self):
        ...
        self.entity_mappings = {
            ...
            "masters/country": {"table": "countries", "id_field": "country_uuid"},
            ...
            "masters-contacts": {"table": "contacts", "id_field": "contact_uuid"},
            ...
            "addresses": {"table": "addresses", "id_field": "address_uuid"},
            "identity/country-mapping": {
                "table": "country_identity_mapping",
                "id_field": "mapping_uuid",
            },
            "identity": {"table": "identity_type", "id_field": "identity_type_uuid"},
            ...
            "bank": {"table": "employee_bank_details", "id_field": "bank_uuid"},
            "pf": {"table": "employee_pf_details", "id_field": "pf_uuid"},
        }
