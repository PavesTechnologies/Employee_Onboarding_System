...
class JWTMiddleware(BaseHTTPMiddleware):
    def __init__(self, app):
        ...
        self.open_endpoints = [
            ...
            "/ems/masters/country",
            "/ems/employee-upload/",
            "/ems/identity/country-mapping",
            "/ems/experience/",
            "/ems/otp/send",
            "/ems/otp/verifyOtp",
            "/ems/education/employee-education-document",
            "/ems/masters/education-level",
            "/ems/education/country-mapping",
            "/ems/education/employee-education-document",
            "/ems/token-verification/",
            "/ems/docusign",
            "/ems/employee-upload/identity-documents",
            "/ems/employee-details",
            "/ems/hr/candidate/submit",
            "/ems/masters/contacts",
            "/ems/generate-offer",
            "/ems/education/degree-master",
            "/ems/bank/",
            "/ems/pf/",
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        if any(path.startswith(ep) for ep in self.open_endpoints):
            print(
                f"[JWTMiddleware] 🟢 Skipping JWT validation for open endpoint: {path}"
            )
            return await call_next(request)
